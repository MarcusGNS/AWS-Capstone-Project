...
DATABASES = {
    'default': {
        ...
        'HOST': 'marcusdb.cpzb4jp3x0uy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'marcusblog' # please enter your s3 bucket name
